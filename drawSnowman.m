...
%display result
%plot(time,motorVolt1,'r', time, motorVolt2, 'b')

pen (1,1) = 1400;
pen (1, size(motorVolt1)) = 1400;

dlmwrite('snowman.txt', [round(motorVolt1'), round(motorVolt2'), pen'])